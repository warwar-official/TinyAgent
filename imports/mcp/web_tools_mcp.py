...
class WebToolsMCP(MCPServer):
    """MCP server that manages the web-related agent tools directly."""
    ...
    def fetch_weather(self, location: str) -> dict:
        tool_answer = {"tool_name": "weather", "tool_arguments": {"location": location}, "tool_result": None, "truncate": False, "error": None}
    ...
    def web_search(self, query: str, count: int = 3) -> dict:
        ...
        tool_answer = {"tool_name": "search", "tool_arguments": {"query": query, "count": count}, "tool_result": None, "truncate": False, "error": None}
    ...
    def web_fetch(self, url: str) -> dict:
        tool_answer = {"tool_name": "fetch", "tool_arguments": {"url": url}, "tool_result": None, "truncate": False, "error": None}
